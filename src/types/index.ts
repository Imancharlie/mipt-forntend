...
export interface RegisterData {
  ...
  phone_number: string;
  student_id?: string;
  program: 'MECHANICAL' | 'ELECTRICAL' | 'CIVIL' | 'COMPUTER' | 'CHEMICAL' | 'TEXTILE_DESIGN' | 'TEXTILE_ENGINEERING' | 'INDUSTRIAL' | 'GEOMATIC' | 'ARCHITECTURE' | 'QUANTITY_SURVEYING' | 'ELECTRONIC_SCIENCE' | 'COMPUTER_ENGINEERING' | 'TELECOMMUNICATIONS' | 'BUSINESS_IT' | 'MINING_ENGINEERING' | 'GEOLOGICAL_ENGINEERING' | 'MINERAL_PROCESSING' | 'PETROLEUM_ENGINEERING' | 'GEOLOGY' | 'GEOPHYSICS' | 'ENVIRONMENTAL_GEOLOGY';
